          ...
          children: [
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const SizedBox(height: 32), // Reduced top margin
                      const Text(
                      ...
                      const SizedBox(
                          height: 12), // Reduced gap below text to login_logo
                      // Login logo
                      Image.asset(
                      ...
                      const SizedBox(
                          height:
                              20), // Reduced gap below login_logo to text field
                      ...
                      const SizedBox(
                          height: 8), // Reduced gap before remember me
                      ...
                      const SizedBox(
                          height: 16), // Reduced gap before login button
                      // Login Button
                      SizedBox(
                      ...
                      const SizedBox(height: 16), // Reduced gap before divider
                      // Divider
                      const Divider(color: AppTheme.textLight2, thickness: 1),
                      const SizedBox(
                          height: 16), // Reduced gap before social login
            ...
            Positioned(
              ...
              child: Image.asset(
                ...
                height: 390, // Set to original height as per design
                fit: BoxFit
